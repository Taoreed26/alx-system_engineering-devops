#!/usr/bin/python3
"""This module creates functions that will querry the reddit API"""
import requests
from sys import argv


def recurse_count(subreddit, hot_list=[], after=None):
    """This function will be used to querry the reddit API recursively
    """
...
def count_words(subreddit, word_list):
    """This function is used to querry the reddit API and also
    ...
    if all_titles:
        for word in word_list:
            ...
            if count:
                ...
                """If a word is duplicated in the function the parameter
                adds all the occurrences
                """
